...
script_path="/Users/pgarcia-nietochanzuckerberg.com/scripts/hca_data_integration/loom/python"
...
python3 $script_path/model_create_from_multiple.py svm_SVC cellType combat $out_h5ad_train $out_h5ad_test ../results/integrated/plots_integration/ $test_loom $train_loom
...
do
    python3 $script_path/model_create_from_multiple.py $model_name cellType concatenate $out_h5ad_train $out_h5ad_test ../results/integrated/plots_integration/ $test_loom $train_loom 
done
