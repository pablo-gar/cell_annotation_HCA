...
python3 $script_path/model_create_from_multiple.py svm_SVC cellType combat False True $out_h5ad_train $out_h5ad_test ../results/integrated/plots_integration/ $test_loom $train_loom
...
do
    python3 $script_path/model_create_from_multiple.py $model_name cellType concatenate False False $out_h5ad_train $out_h5ad_test ../results/integrated/plots_integration/ $test_loom $train_loom 
done
